jQuery(document).ready(function ($) {
	...
	$('.hamburger, .mobile-menu_close').click(function(){
...
$('#nav').slick({
    ...
    draggable: true,
    arrows: true,
    prevArrow: '<div class="prev_left"></div>',
    nextArrow: '<div class="next_right"></div>',
    ...
    $(".tabs_project_list li").click(function () {
        ...
        if (countItems > 0 & Tnumber != "#T1" & buttonMore < 1) {
            ...
            $(Tnumber + ' .point_enter').append("<a class='show_more' href='#none'><img src='/wp-content/themes/s-a-ricci/img/arrow-pointing-to-right.png' alt='arrow'> " + Translete.btnMoreProjects + "</a>");
    ...
    if ($('#T1').find(".tabs_container__item:not(:visible)").length > 0) {
        $("#T1 .point_enter").append("<a class='show_more t1' href='#none'><img src='/wp-content/themes/s-a-ricci/img/arrow-pointing-to-right.png' alt='arrow'> " + Translete.btnMoreProjects + "</a>");
    }
    ...
    if ($('div').is('.site_message')) {
        $('body').css('paddingTop', $('.site_message').height());
    }
